...
CREATE TABLE `Address` (
  ...
  CONSTRAINT `Address_ibfk_1` FOREIGN KEY (`address_id`) REFERENCES `Service` (`address_id`),
  CONSTRAINT `Address_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `Guest` (`address_id`)
...
CREATE TABLE `Event_expense` (
  ...
  `event_service_id` int DEFAULT NULL,
...
CREATE TABLE `Guest_table` (
  ...
  CONSTRAINT `Guest_table_ibfk_1` FOREIGN KEY (`table_id`) REFERENCES `Table` (`table_id`),
...
CREATE TABLE `Table` (
  ...
  KEY `event_id` (`event_id`),
  CONSTRAINT `Table_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `Event` (`event_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
